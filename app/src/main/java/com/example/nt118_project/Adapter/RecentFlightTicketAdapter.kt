...
class RecentFlightTicketAdapter (private var dataList: ArrayList<FlightTicket>, private var context: Context): RecyclerView.Adapter<RecentFlightTicketAdapter.RecentFlightTicketViewHolder>() {

    public var onItemClick: ((FlightTicket) -> Unit)? = null
    inner class RecentFlightTicketViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecentFlightTicketViewHolder {
        ...
        return RecentFlightTicketViewHolder(itemView)
    }
    ...
    override fun onBindViewHolder(holder: RecentFlightTicketViewHolder, position: Int) {
